...
pub const swiden_low_ext = Ir.swiden_low_ext;
pub const swiden_high_ext = Ir.swiden_high_ext;
pub const uwiden_low_ext = Ir.uwiden_low_ext;
pub const uwiden_high_ext = Ir.uwiden_high_ext;
...
pub const uload8_ext = Ir.uload8_ext;
pub const uload16_ext = Ir.uload16_ext;
pub const uload32_ext = Ir.uload32_ext;
pub const sload8_ext = Ir.sload8_ext;
pub const sload16_ext = Ir.sload16_ext;
pub const sload32_ext = Ir.sload32_ext;
